...
This is just a fork of https://gitlab.inria.fr/fpottier/visitors.
Making my own modifications to the library until it gets updated to last version of ppx_deriving
